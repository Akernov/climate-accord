            ...
            return (
              ...
              >
                ...
                <button 
                  ...
                  className={`w-full py-3 rounded-xl font-black uppercase tracking-wider transition-colors ${
                      isSpectator ? 'bg-gray-800 text-gray-500 cursor-not-allowed opacity-50 border border-gray-700' :
